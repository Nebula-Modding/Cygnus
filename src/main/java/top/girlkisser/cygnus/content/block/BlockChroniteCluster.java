...
public class BlockChroniteCluster extends AmethystClusterBlock
{
	public BlockChroniteCluster(float height, float aabbOffset, Properties properties)
	{
	...
	{
		if (!BlockChronite.canEntityWalkOnChronite(entity))
